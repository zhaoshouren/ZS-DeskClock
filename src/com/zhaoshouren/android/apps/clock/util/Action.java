...
public class Action {
     ...
     */
    public static final String ALERT = "zs.clock.intent.action.ALARM_ALERT";
    /**
     * This action triggers the AlarmBroadcastReceiver as well as the AlarmPlayerService. It is a
     * public action used in the manifest for receiving Alarm broadcasts from the alarm manager.
     */
    public static final String ALERT_FULL_SCREEN = "zs.clock.intent.action.ALARM_ALERT_FULL_SCREEN";
    /**
     ...
     * phone call, etc).
     */
    public static final String DONE = "zs.clock.intent.action.ALARM_DONE";
    /**
     ...
     */
    public static final String SNOOZE = "zs.clock.intent.action.ALARM_SNOOZE";
    /**
     ...
     */
    public static final String DISMISS = "zs.clock.intent.action.ALARM_DISMISS";
    /**
     * This is an action used by the AlarmPlayerService to update the UI to show the alarm has been
     * killed.
     */
    public static final String KILLED = "zs.clock.intent.action.ALARM_KILLED";
    /**
     * Extra in the ACTION_ALARM_KILLED intent to indicate to the user how long the alarm played
     * before being killed.
     */

    public static final String SNOOZE_CANCEL = "zs.clock.intent.action.ALARM_SNOOZE_CANCEL";
