...
public class SetAlarmPreferenceActivity extends PreferenceActivity implements
    ...
    protected void onCreate(final Bundle icicle) {
        ...
        case INVALID_ID:
            ...
            break;
        case GET_NEXT_ALARM:
            mAlarm = Alarms.getNextEnabledAlarm(this);
            if (mAlarm == null) {
                Log.e(TAG,
        ...
        default:
            ...
            mAlarm = Alarms.getAlarm(this, alarmId);
            if (mAlarm == null) {
                Log.e(TAG,
                        "SetAlarmPeferenceActivity.onCreate(): failed to get an Alarm from Alarm.createFromRawData(Context, byte[])");
                finish();
        ...
        ((Button) findViewById(R.id.alarm_save)).setOnClickListener(new View.OnClickListener() {
            public void onClick(final View v) {
                Alarms.popAlarmSetToast(SetAlarmPreferenceActivity.this, mAlarm);
                saveAlarm();
                finish();
            }
        });
    ...
    private void saveAlarm() {
        ...
        sHandler.post(new Runnable() {
            public void run() {
                Alarms.saveAlarm(SetAlarmPreferenceActivity.this, mAlarm);
            }
        });
    }
        ...
        new AlertDialog.Builder(this).setTitle(getString(R.string.delete_alarm))
                ...
                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    public void onClick(final DialogInterface d, final int w) {
                        sHandler.post(new Runnable() {
                            public void run() {
                                Alarms.deleteAlarm(SetAlarmPreferenceActivity.this, mAlarm.id);
                            }
                        });
                        finish();
                    }
