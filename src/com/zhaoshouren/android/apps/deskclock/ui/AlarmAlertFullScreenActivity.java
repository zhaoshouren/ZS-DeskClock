...
public class AlarmAlertFullScreenActivity extends Activity {
    ...
    private static final IntentFilter sIntentFilter = new IntentFilter(Alarms.ACTION_ALARM_KILLED);
    static {
        sIntentFilter.addAction(Alarms.ACTION_ALARM_SNOOZE);
        sIntentFilter.addAction(Alarms.ACTION_ALARM_DISMISS);
    }
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (action == Alarms.ACTION_ALARM_SNOOZE) {
                snooze();
            } else if (action == Alarms.ACTION_ALARM_DISMISS) {
                dismiss(false);
            } else {
    ...
    private void snooze() {
        ...
        cancelSnoozeIntent.setAction(Alarms.CANCEL_SNOOZE);
        ...
        stopService(new Intent(Alarms.ACTION_ALARM_ALERT));
        finish();
    }
